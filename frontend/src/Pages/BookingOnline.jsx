...
import BookingAppoinment from '../component/newComponent/BookingAppoinment';
import { CSSTransition, TransitionGroup } from 'react-transition-group';

const BookingOnline = () => {
  return (
    <div className="flex flex-col bg-white h-full items-center">
    <div className="w-full md:w-1/2 p-4 border-2 border-gray-100 shadow-md rounded-lg bg-white my-14 mr-77" style={{ Width: '1600px', Height: '300px', overflowY: 'auto' }}>
      ...
      <div className="w-full md:w-1/2 bg-white " style={{ maxWidth: '800px' }}>
        <BookingForm3 />
      </div>
    </div>
  );
